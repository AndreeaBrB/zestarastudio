...
import { Sparkles, Image as ImageIcon, BookOpen, Music, Film, Mic, Zap } from "lucide-react"
import { CartIcon } from "@/components/cart-icon"
import { useCart } from "@/lib/cart-context"

const navItems = [
    { name: "Image Studio", href: "/image", icon: ImageIcon },
    { name: "Story Lab", href: "/story", icon: BookOpen },
    { name: "Music Creator", href: "/music", icon: Music },
    { name: "Animation Bay", href: "/animation", icon: Film },
